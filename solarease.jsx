...
async function askClaude(messages) {
  const res = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    body: JSON.stringify({
      ...
      system: `Та SolarEase платформын нарны цахилгаан үүсгүүрийн AI зөвлөх. Монгол хэлээр хариулна. Дорноговь аймгийн нөхцөлд тооцоо хийнэ. Үргэлж тодорхой тоон утгатай тооцоо гарга.
Гол параметрүүд: 1kW=2,700,000₮ | Нарны цацраг: 1980 kWh/kW/жил | Экспортын тариф: 343₮/kWh | Карбон механизм: 20% хөнгөлөлт | Ногоон зээл: 3%, 60 сар`,
      messages,
    }),
  });
  const d = await res.json();
  return d.content?.[0]?.text || "Алдаа гарлаа. Дахин оролдоно уу.";
}
